...
public class Ligne {
  ...
  public Ligne(int qte, Produit produit) {
	...
	FloatBinding prix = Bindings.selectFloat(this.produit, "prix");
	FloatBinding TVA = Bindings.selectFloat(this.produit, "tva");
	
    NumberExpression ligne = Bindings.multiply(this.qte, prix);
    this.totalHT = ligne;
    this.totalTTC = Bindings.multiply(this.totalHT, TVA);
